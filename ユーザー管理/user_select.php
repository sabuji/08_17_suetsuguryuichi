...
if ($status==false) {
    ...
    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $view .= '<p>'.$result['id'].'-'.$result['name'].'-'.$result['lid'].'-'.$result['lpw'].'-'.$result['kanri_frg'].'-'.$result['life_frg'].'</p>';
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">ユーザーリスト一覧</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="user_index.php">ユーザーリスト登録</a>
                    </li>
                </ul>
            </div>
        </nav>
